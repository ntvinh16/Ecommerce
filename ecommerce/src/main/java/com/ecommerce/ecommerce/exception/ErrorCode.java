...
public enum ErrorCode {
    ...
    USERNAME_INVALID(2205, "Username must be ad least 4 characters and at most 20 characters", HttpStatus.BAD_REQUEST),
    PASSWORD_INVALID(2206, "Password must be ad least 8 characters and at most 20 characters", HttpStatus.BAD_REQUEST),
